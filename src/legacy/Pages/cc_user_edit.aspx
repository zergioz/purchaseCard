						...
						<div class="form-group row">
							...
							<div class="col-sm-12" id="the-basics">
								<select id="billingOfficialCardHolder" class="inputTextCCUser form-control"
									name="cardHolder[]" multiple="multiple" placeholder="Add Card Holders Accounts"
									style="width: 100%">
								</select>
							</div>
						</div>
					...
					<div class="row">
						<div class="col col-lg-12">
							<button type="button" class="btn btn-sm btn-block btn-success" data-toggle="modal"
								data-target="#myModal" onclick="pushUserData('updateAccount')"><i
	...
	<div class="modal fade" id="myModal" role="dialog">
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<button id="uploadedFileDone" type="button" class="btn btn-dark" id="btnclose"

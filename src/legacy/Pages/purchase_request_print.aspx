...
<body class="loading">
	<form id="form1" runat="server">
		...
		<div class="container">
			<div class="row mb-0">
				<div class="col-12">
					<button type="button" id="closeRequestWindow" class="btn btn-block btn-secondary"
						onclick="window.print();" value="print">PRINT <i class="fa fa-print"></i></button>
				</div>
			</div>
							...
							<div class="input-group">
								<div id="bloodhound">
									<input type="text" class="typeahead form-control shadow-sm" id="Requestor"
										placeholder="Name Lookup_" disabled="disabled">
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<div class="col-lg-8">
							<textarea rows="5" id="RequestJustification" class="form-control shadow-sm  form-control-sm"
								placeholder="Please provide a justification for what you are purchasing" required
					...
					<div class="row">
						...
						<div class="col-lg-1">
							<input id="RequestCurrencyType" type="checkbox" checked data-toggle="toggle" data-on="USD"
								data-off="EUR" disabled="disabled">
						</div>
					</div>
					<hr>
					<!-- ROW SEVEN -->
											...
											<div class="row mb-0">
												<div class="col-9">
													<textarea rows="5" id="directorateComments"
														...
														placeholder="Provide Financial Director Comments" required
														disabled="disabled"></textarea>
											...
											<div class="row">
												<div class="col-9">
													<textarea rows="5" id="boComments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Provide Billing Official Comments" required
														disabled="disabled"></textarea>

													<div class="input-group">
														<input class="form-control shadow-sm  form-control-sm"
															type="text" name="boSignature" id="boSignature"
															placeholder="Signature" disabled="disabled">
													</div>
												</div>
											...
											<div class="row">
												<div class="col-9">
													<textarea rows="5" id="j6Comments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Provide J6 Comments" required
														disabled="disabled"></textarea>
											...
											<div class="row">
												<div class="col-9">
													<textarea rows="5" id="pboComments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Provide PBO  Comments" required
														disabled="disabled"></textarea>
											...
											<div class="row">
												<div class="col-9">
													<textarea rows="5" id="j8Comments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Provide J8 Comments" required
														disabled="disabled"></textarea>
												</div>
												<div class="col-3">
													<div class="input-group mb-3">
											...
											<div class="row">
												<div class="col-12">
													<textarea rows="5" id="cardHolderComments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Provide Cardholder Comments" required
														disabled="disabled"></textarea>
												</div>
											</div>
											<div class="row">
												<div class="col-12">
													<input rows="5" id="cardHolderTransactionId"
														...
														name="cardHolderTransactionId" required="required"
														disabled="disabled"></input>
													<!-- SIGN OPTION -->
													<div class="input-group">
														<input class="form-control shadow-sm  form-control-sm"
															type="text" name="cardHolderSignature"
															id="cardHolderSignature" placeholder="Card Holder Signature"
															disabled="disabled">
													</div>
												</div>
											</div>
											...
											<div class="row">
												<div class="col-12">
													<textarea rows="5" id="requestorComments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Requestor Comments" required
														disabled="disabled"></textarea>
											...
											<div class="row">
												<div class="col-12">
													<textarea rows="5" id="supplyComments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="SOHC Supply Comments" required
														disabled="disabled"></textarea>
													<div class="input-group">
														<input class="form-control shadow-sm  form-control-sm"
											...
											<div class="row">
												<div class="col-12">
													<textarea rows="5" id="j4Comments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Provide J4 Comments" required
														disabled="disabled"></textarea>
													<!-- SIGN OPTION -->
													<div class="input-group">
														<input class="form-control shadow-sm  form-control-sm"
											...
											<div class="row">
												<div class="col-lg-12">
													<textarea rows="5" id="budgetOfficerComments"
														class="form-control shadow-sm  form-control-sm"
														placeholder="Billing Official Final Comments" required
														disabled="disabled"></textarea>
												</div>
											</div>
											<div class="row">
								...
								<div class="row mb-0">
									<div class="col-12">
										<button type="button" id="closeRequestWindow"
											class="btn btn-block btn-secondary" onclick="window.print();"
											value="print">PRINT <i class="fa fa-print"></i></button>
									</div>
								</div>
							</div>
						</div>

				...
				<nav class="sidebar-nav">
					...
					<div class="collapse nav-toggleable-md" id="nav-toggleable-md">
						<ul class="nav nav-pills nav-stacked flex-column">
							...
							<li class="nav-item"><a class="nav-link active" href="cc_purchase_request_list.aspx">Request
									Status</a></li>
							<li class="nav-item"><a class="nav-link" href="purchase_request.aspx" target="_blank">Submit
									Request</a></li>
				...
				<div class="row text-center mt-5">
					<div class="col-md-4 mb-4 mb-md-3">
						<div class="w-3 mx-auto">
							<canvas class="ex-graph" width="200" height="200" data-chart="doughnut"
					...
					<div class="col-md-4">
						<div class="statcard statcard-success">
							<div class="p-3">
								...
								<h2 class="statcard-number">1,293 <small
										class="delta-indicator delta-positive">5%</small></h2>
								<hr class="statcard-hr mb-0">
							</div>
							<canvas id="sparkline1" width="378" height="94" class="sparkline" data-chart="spark-line"
								data-dataset="[[28,68,41,43,96,45,100]]" data-labels="['a','b','c','d','e','f','g']"
					...
					<div class="col-md-4">
						<div class="statcard statcard-danger">
							<div class="p-3">
								<span class="statcard-desc">Credit Limit</span>
								<h2 class="statcard-number">1,293 <small
										class="delta-indicator delta-negative">1.3%</small></h2>
								<hr class="statcard-hr mb-0">
							</div>
							<canvas id="sparkline1" width="378" height="94" class="sparkline" data-chart="spark-line"
								data-dataset="[[4,34,64,27,96,50,80]]" data-labels="['a', 'b','c','d','e','f','g']"
								style="width: 189px; height: 47px;">
							</canvas>
						</div>
					</div>
					<div class="col-md-4">
						<div class="statcard statcard-info">
							<div class="p-3">
								<span class="statcard-desc">Credit Limit</span>
								<h2 class="statcard-number">1,293 <small
										class="delta-indicator delta-positive">6.75%</small></h2>
								<hr class="statcard-hr mb-0">
							</div>
							<canvas id="sparkline1" width="378" height="94" class="sparkline" data-chart="spark-line"
								data-dataset="[[12,38,32,60,36,54,68]]" data-labels="['a', 'b','c','d','e','f','g']"
								style="width: 189px; height: 47px;">
							</canvas>
						</div>
					</div>
				...
				<div class="card mb-4 box-shadow">
					...
					<div class="text-center pager tablesorter-pager">
						<nav class="navbar navbar-expand-lg navbar-light bg-light">
							<ul class="navbar-nav">
								<li class="nav-item">
									<a class="nav-link prev disabled" href="#" aria-label="Previous Page" tabindex="0"
										title="Previous page" alt="Prev">
										<span aria-hidden="true">&laquo; Previous</span>
									</a>
								</li>
								<li class="nav-item">
									<a class="nav-link next disabled" href="#" aria-label="Next" tabindex="0"

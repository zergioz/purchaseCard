...
<SharePoint:FormDigest  ID="FormDigest1" runat="server"></SharePoint:FormDigest>
	...
	<div class="container-fluid">	
		<div class="row mb-1 mb-4 box-shadow">
			...
			<div class="col-lg-2">
				<button type="button" class="btn btn-sm btn-block btn-secondary" id="btnViewPrint" value="Submit"  title="Print Version"><i class="fa fa-upload"></i> View Print Version</button>	
			</div>
		</div>
	</div>
	<!--END BUTTON ROW-->
				...
				<div class="row">
					...
					<div class="container-fluid">
						<ul class="nav nav-tabs flex-sm-row col-lg-12 nav-justified">
							...
							<li class="nav-item">
								<a class="nav-link" data-toggle="tab" href="#cardHolderPane"><p id="cardHolderText">CardHolder</p></a>
							</li>
							<li class="nav-item">

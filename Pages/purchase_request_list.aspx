					...
					<nav class="sidebar-nav">
						...
						<div class="collapse nav-toggleable-md" id="nav-toggleable-md">
							<ul class="nav nav-pills nav-stacked flex-column">
								...
								<li class="nav-item"><a class="nav-link active" href="/cc/Pages/purchase_request_list.aspx">Request Status</a></li>
								...
								<li class="nav-item"><a class="nav-link" href="http://soceur.sof.socom.smil.mil/cc/Shared%20Documents/Forms/AllItems.aspx" target="_blank">Documentation</a></li>
